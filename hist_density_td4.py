...
def plot_density(y1,y2,y3,y4,f1,t):
    ...
    sns.kdeplot(X4, label='s4', linewidth=3.0, color='red',cut=0)
...
def plot_hista(y1, y2, y3,y4,f2,t):
    ...
    plt.bar(center4, bin_height4,width=width4, linewidth=4, zorder=2, color='red', label="s4")
    plt.xlabel('Radius of Gyration /(Angstrom)', weight='bold', fontsize=14)
...
def plot_td(x1,y1,x2,y2,x3,y3,x4,y4,f3,t):
    ...
    plt.plot(x4,y4, label='s4', linewidth=2, color='red')
    plt.ylabel('Radius of Gyration /(Angstrom)', weight='bold', fontsize=14)
